...
def compute_vS(model,x, edge_index,y,softmax_func, length, num_of_order, num_of_samples, num_of_inputs):
    logits = model(x, edge_index)  # (length * num_of_order * num_of_samples * num_of_inputs, out_dim)
